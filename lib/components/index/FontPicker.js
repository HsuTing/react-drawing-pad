...
var _fontPicker = require('./style/fontPicker');
...
var FontPicker = (0, _radium2.default)(_class = (_temp = _class2 = function (_React$Component) {
  _inherits(FontPicker, _React$Component);

  function FontPicker(props) {
    _classCallCheck(this, FontPicker);

    var _this = _possibleConstructorReturn(this, (FontPicker.__proto__ || Object.getPrototypeOf(FontPicker)).call(this, props));

    _this.state = {
      size: _this.props.defaultSize || _static2.default.defaultSize
    };
  ...
  _createClass(FontPicker, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        _extends({}, props, {
          style: [_controlBar.item, _fontPicker2.default.root, this.props.style]
        }),
        _react2.default.createElement(
          'div',
          { style: _fontPicker2.default.text },
          'SIZE\uFF1A'
        ),
        _react2.default.createElement('input', { value: size,
          style: _fontPicker2.default.input,
